...
MyGame.loader = (function() {
    ...
    let scriptOrder = [{
            ...
            message: 'Keyboard system model loaded',
            onComplete: null
        }, {
            scripts: ['render/core'],
            ...
            message: 'Rendering background loaded',
            onComplete: null
        }, {
            scripts: ['render/frog'],
            message: 'Rendering frog loaded',
            onComplete: null
        }, {
            scripts: ['render/hud'],
            message: 'Rendering hud loaded',
            onComplete: null
        }, {
            scripts: ['render/log'],
            message: 'Rendering log loaded',
            onComplete: null
        }, {
            scripts: ['render/vehicle'],
            message: 'Rendering vehicle loaded',
            onComplete: null
        }, {
            scripts: ['gameplay'],
